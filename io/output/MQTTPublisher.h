...
public:
	...
	static void publish(MQTT::Client<IPStack, Countdown> * client, char* const topic, char* const msg) {
	...
	static void publish(MQTT::Client<IPStack, Countdown> * client, char* const topic, float const value) {
		char buf[21];
